...
.notification_item.fade-out {
    ...
    transform: translateX(100%); /* 요소를 오른쪽으로 100% 이동 (오른쪽으로 슬라이드 아웃) */
    ...
    transition: 
        ...
        height 0.5s 0.2s ease-out, /* 높이 변화는 약간 늦게 시작 */
...
.notification_item {
    ...
    cursor: pointer;
    /* 트랜지션 유지 및 추가 */
    transition: opacity 0.2s, background-color 0.2s, transform 0.2s, height 0.2s, padding 0.2s; 
}
/* ... 나머지 CSS 코드는 변경 없음 ... */
                ...
                <ul class="header_menu_list flex">
                    ...
                    <c:if test="${userInfo != null}">
                        <li>
                            ...
                            <a href="/logoutByUser.do" onclick="return confirmLogout()">로그아웃</a>
                        </li>
            ...
            <c:if test="${userInfo != null}">
                <c:if test="${userInfo['MEMBER_TYPE'] == 'user'}">
                    <div class="notification_area">
                        <button class="btn_notification" onclick="toggleNotificationPopup()">
                        ...
                        <div class="notification_popup" id="notificationPopup">
                            ...
                            <div class="popup_body" id="notificationList">
                                </div>
                        </div>
                    </div>
                </c:if>
