(function () {
  return function () {
    ...
    this.on_create = function () {
      ...
      var Div00_00_00_00_00_form_Radio00_innerdataset =
        new nexacro.NormalDataset(
          "Div00_00_00_00_00_form_Radio00_innerdataset",
          obj
        );
      Div00_00_00_00_00_form_Radio00_innerdataset._setContents(
        '<ColumnInfo><Column id="codecolumn" size="256"/><Column id="datacolumn" size="256"/></ColumnInfo><Rows><Row><Col id="codecolumn">all</Col><Col id="datacolumn">전체</Col></Row><Row><Col id="codecolumn">Y</Col><Col id="datacolumn">진열함</Col></Row><Row><Col id="codecolumn">N</Col><Col id="datacolumn">진열안함</Col></Row></Rows>'
      );
      ...
      obj.set_direction("vertical");
      obj.set_font('normal 800 10pt/normal "Arial"');
      var Div00_00_00_00_00_form_Radio00_00_innerdataset =
        new nexacro.NormalDataset(
          "Div00_00_00_00_00_form_Radio00_00_innerdataset",
          obj
        );
      Div00_00_00_00_00_form_Radio00_00_innerdataset._setContents(
        '<ColumnInfo><Column id="codecolumn" size="256"/><Column id="datacolumn" size="256"/></ColumnInfo><Rows><Row><Col id="codecolumn">allS</Col><Col id="datacolumn">전체</Col></Row><Row><Col id="codecolumn">sale</Col><Col id="datacolumn">판매함</Col></Row><Row><Col id="codecolumn">nosale</Col><Col id="datacolumn">판매안함</Col></Row></Rows>'
      );
      ...
      obj.set_codecolumn("codecolumn");
      obj.set_datacolumn("datacolumn");
      var cmb_searchType_innerdataset = new nexacro.NormalDataset(
        "cmb_searchType_innerdataset",
        obj
      );
      cmb_searchType_innerdataset._setContents(
        '<ColumnInfo><Column id="codecolumn" size="256"/><Column id="datacolumn" size="256"/></ColumnInfo><Rows><Row><Col id="codecolumn">PRODUCT_CODE</Col><Col id="datacolumn">상품코드</Col></Row><Row><Col id="codecolumn">PRODUCT_NAME</Col><Col id="datacolumn">상품명</Col></Row></Rows>'
      );
      ...
      obj.set_text("    엑셀다운로드");
      obj.set_background(
        "url('imagerc::excel_logo.png') no-repeat left center /30px"
      );
    ...
    this.registerScript("Form_Product.xfdl", function () {
      ...
      this.fn_makeSearchCond = function () {
        ...
        this._setCond(
          this.ds_searchCond,
          "SEARCH_TYPE",
          this.cmb_searchType.value
        ); // 검색분류 (PRODUCT_CODE/PRODUCT_NAME)
        this._setCond(
          this.ds_searchCond,
          "SEARCH_TEXT",
          this.Div00_00.form.edt_search.text
        ); // 검색어
        this._setCond(
          this.ds_searchCond,
          "IS_VISIBLE",
          this.Div00_00_00_00_00.form.Radio00.value
        ); // 진열상태(all,Y,N)
        // 컬럼 통일: QUANTITY_STATUS 로 보냄 (mapper와 일치)
        this._setCond(
          this.ds_searchCond,
          "QUANTITY_STATUS",
          this.Div00_00_00_00_00.form.Radio00_00.value
        ); // 판매상태(allS,sale,nosale)
        this._setCond(
          this.ds_searchCond,
          "START_DATE",
          this._dateOrEmpty(this.cal_start)
        ); // 시작일
        this._setCond(
          this.ds_searchCond,
          "END_DATE",
          this._dateOrEmpty(this.cal_end)
        ); // 종료일
      ...
      this.getUserId = function () {
        ...
        if (sUserId && sUserId != "undefined") {
          ...
          trace(
            "⚠ 사용자 ID를 가져올 수 없습니다. gds_adminInfo 상태 확인 필요"
          );
          return null;
        }
      };
      ...
      this._ensureFileDownload = function () {
        // 이미 만들어둔 적 있으면 재사용
        if (this.filedown && this.filedown instanceof nexacro.FileDownload)
          return;

        // 동적으로 FileDownload 생성
        var fd = new nexacro.FileDownload(
          "filedown",
          0,
          0,
          0,
      ...
      this.btn_excel_onclick = function (obj, e) {
        ...
        if (this.ds_out_proList.getRowCount() === 0) {
          if (!this.confirm("조회된 데이터가 없습니다. 헤더만 다운로드할까요?"))
            return;
        }
    ...
    this.on_initEvent = function () {
      ...
      this.Div00_00_00_00_00.form.Radio00_00.addEventHandler(
        "onitemchanged",
        this.Div00_00_00_00_00_Radio00_00_onitemchanged,
        this
      );
      this.grid_list.addEventHandler(
        "oncelldblclick",
        this.grid_list_oncelldblclick,
        this
      );
      this.grid_list.addEventHandler(
        "onkeydown",
        this.grid_list_onkeydown,
        this
      );
      this.grid_list.addEventHandler(
        "onkillfocus",
        this.grid_list_onkillfocus,
        this
      );
      this.grid_list.addEventHandler(
        "oncellclick",
        this.grid_list_oncellclick,
        this
      );
      this.sta_listTitle.addEventHandler(
        "onclick",
        this.sta_listTitle_onclick,
        this
      );
      this.sta_prodType.addEventHandler(
        "onclick",
        this.sta_prodType_onclick,
        this
      );
      this.cmb_searchType.addEventHandler(
        "onitemchanged",
        this.cmb_searchType_onitemchanged,
        this
      );
      this.cmb_cate1.addEventHandler(
        "onitemchanged",
        this.cmb_cate1_onitemchanged,
        this
      );
      this.sta_listTitle00.addEventHandler(
        "onclick",
        this.sta_listTitle_onclick,
        this
      );
      ...
      this.ds_out_proList.addEventHandler(
        "oncolumnchanged",
        this.ds_out_proList_oncolumnchanged,
        this
      );
    };
