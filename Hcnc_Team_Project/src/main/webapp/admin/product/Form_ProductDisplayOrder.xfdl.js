(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("Form_Product_copy0.xfdl","common::common.xjs");
        this.registerScript("Form_Product_copy0.xfdl", function() {
        ...
        this.loadIncludeScript("Form_Product_copy0.xfdl");
