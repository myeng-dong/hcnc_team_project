(function()
{
    return function()
    {
        ...
        this.btn_load_onclick = function(obj,  e)
        {
        	...
        	var image1 = "http://localhost:8080/RichTextEditor17/ui/file/richtexteditor/repository/birthday.jpg";
        	var image2 = "http://localhost:8080/RichTextEditor17/ui/file/richtexteditor/repository/ChristmasTree.jpg";
