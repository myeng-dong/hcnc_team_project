(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"REVIEW_ID\" type=\"STRING\" size=\"256\"/><Column id=\"COMMENT_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new TextArea("txt_content","20","50",null,"266","20",null,null,null,null,null,this);
            ...
            obj = new Static("안내","360","325","120","14",null,null,null,null,null,null,this);
            obj.set_taborder("6");
        ...
        // User Script
        this.registerScript("Pop_BaordReport.xfdl", function() {
        //온로드시
        this.Pop_BoardReport_onload = function(obj,e)
        {
        	var reviewId = this.parent["REVIEW_ID"];  // 리뷰 아이디를 부모에게 받아옴
        	var commentId = this.parent["COMMENT_ID"]; // 댓글 아이디를 부모에게 받아옴


        	if(reviewId){
        		this.ds_search.setColumn(0,"REVIEW_ID",reviewId ); //리뷰 아이디 셋
        		this.fnselectReviewCommentByAdmin();
        	}else{
        		this.ds_search.setColumn(0,"COMMENT_ID",commentId); //코멘트 아이디 셋
        		this.fnselectReviewCommentByAdmin();
        	}
        ...
        // 신고받은 리뷰 or 댓글 상세 조회 트랜젝션
        this.fnselectReviewCommentByAdmin = function(){
        	var strSvcID       = "selectReviewCommentByAdmin";
            var strURL         = "svc::selectReviewCommentByAdmin.do?time=" + new Date().getTime();
        ...
        this.fnCallback = function(svcID, errCode, errMsg) {
            ...
            switch(svcID) {
        		...
        		case "selectReviewCommentByAdmin":
        			trace("게시글 조회 완료");
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onload",this.Pop_BoardReport_onload,this);
            this.stc_title.addEventHandler("onclick",this.stc_title_onclick,this);
        };
        this.loadIncludeScript("Pop_BaordReport.xfdl");
