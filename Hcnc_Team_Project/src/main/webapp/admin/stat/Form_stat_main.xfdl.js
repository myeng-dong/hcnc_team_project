(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("search_area",null,"40","590",null,"40","150",null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Combo("Combo00","430","17","120","36",null,null,null,null,null,null,this.search_area.form);
            obj.set_taborder("2");
            obj.set_text("Combo00");
            this.search_area.addChild(obj.name, obj);

            obj = new Grid("grid_list",null,"100","590",null,"40","40",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_background("#FFFFFF");
            ...
            obj = new Grid("grid_list00","40","40","590",null,null,"40",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_background("#FFFFFF");
            obj.set_border("0px none");
            obj.set_borderRadius("10px");
            ...
            obj = new BindItem("item1","grid_list00","binddataset","ds_user","");
            this.addChild(obj.name, obj);
            obj.bind();
