    ...
    */
	...
	//                }
	  ...
	  _pExtFileUpload.on_fire_onloadstart = function (obj, type, evt, fileId)
	  {
		...
		_pExtFileUpload.on_fire_onload = function (type, code, msg, url, fileId)
		{
		...
		{   
			...
			*/
			...
			{            
				...
				//trace("=== ajax_handle.readyState=" + ajax_handle.readyState);
		...
		{
			//trace("aaa _makeReadystateChangeHandler pFileId="+pFileId + ",pType="+pType);
			return function(evt) {
		...
		_pExtFileUpload.on_load_filemodule = function (type, code, msg, url)
		{
			//trace("on_load_filemodule type:" + type + ",code:" + code + ",msg:" + msg + ",url:" + url);
			this.on_fire_onload(type, code, msg, url);
		};
		
		
		_pExtFileUpload.on_loadframe_filemodule = function (type, code, msg, url)
		{
		...
		_pExtFileUpload._dragLeaveGuide = function (evt) 
		{
			...
			var rcRight  = size[0] - rcLeft;
			var rcBottom = size[1] - rcTop;	

			trace("_dragLeaveGuide :" + cx + " , " + cy);
			//trace("  -> guideComp Area: left=" + rcLeft + ", top="  + rcTop + ", rcRight=" + rcRight + ", rcBottom="  + rcBottom );
