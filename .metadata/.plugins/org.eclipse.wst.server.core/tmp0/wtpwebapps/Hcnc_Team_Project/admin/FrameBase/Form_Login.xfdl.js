(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("stc_TITLE1","40","10","120","60",null,null,null,null,null,null,this);
            obj.set_text("메인화면");
            obj.set_font("28px/normal \"Gulim\"");
            obj.set_taborder("4");
            this.addChild(obj.name, obj);

            obj = new Static("stc_id","35","75","140","50",null,null,null,null,null,null,this);
            obj.set_text("아이디");
            ...
            obj = new Edit("edt_id","205","80","155","40",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stc_pw","35","145","140","50",null,null,null,null,null,null,this);
            obj.set_text("비밀번호");
            obj.set_background("#565656");
            obj.set_borderRadius("4px");
            obj.set_color("#ffffff");
            obj.set_font("normal 20px \"bold\"");
            obj.set_textAlign("center");
            obj.set_taborder("6");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_pw","205","150","155","40",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            ...
            obj = new BindItem("item0","edt_pw","value","ds_user","pw");
            this.addChild(obj.name, obj);
            obj.bind();
        	...
        	switch(svcID)
        	{
        		case "selectUser"://사용자 조회
        			if (errorCode >= 0) {
        				...
        				application.open("Form_Sign", "Form_Sign.xfdl", null, null, null, null);
        				return;
        			}else {
        ...
        {
        	//application.open("form_Sign", "sample::Form_Sign.xfdl", null, null, null, null);
        	this.getOwnerFrame().set_formurl("sample::Form_Sign.xfdl");
        };
